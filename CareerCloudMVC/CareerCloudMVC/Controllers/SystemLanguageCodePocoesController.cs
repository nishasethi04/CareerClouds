...
{
    public class SystemLanguageCodePocoesController : Controller
    {
        private readonly CareerCloudContext _context;

        public SystemLanguageCodePocoesController(CareerCloudContext context)
        {
            _context = context;
        }

        // GET: SystemLanguageCodePocoes
        public async Task<IActionResult> Index()
        {
            return View(await _context.SystemLanguageCodes.ToListAsync());
        }

        // GET: SystemLanguageCodePocoes/Details/5
        ...
        // GET: SystemLanguageCodePocoes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: SystemLanguageCodePocoes/Create
        ...
        // GET: SystemLanguageCodePocoes/Edit/5
        ...
        // POST: SystemLanguageCodePocoes/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: SystemLanguageCodePocoes/Delete/5
        ...
        // POST: SystemLanguageCodePocoes/Delete/5
