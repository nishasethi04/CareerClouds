...
namespace AdventureDb
{
    ...
    public partial class AdventureWorks2017Entities : DbContext
    {
        ...
        public virtual int Sp_Ins(string name, string gN, Nullable<System.DateTime> mD)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_Ins", nameParameter, gNParameter, mDParameter);
        }
    
        public virtual int Sp_Ins1(string name, string gN, Nullable<System.DateTime> mD)
        {
            var nameParameter = name != null ?
                new ObjectParameter("name", name) :
                new ObjectParameter("name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_Ins1", nameParameter, gNParameter, mDParameter);
        }
    
        public virtual int Sp_Ins2(string gN, Nullable<System.DateTime> mD, string name)
        {
            var gNParameter = gN != null ?
                new ObjectParameter("GN", gN) :
                new ObjectParameter("GN", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_Ins2", gNParameter, mDParameter, nameParameter);
        }
    
        public virtual ObjectResult<sp_try_Result> sp_try(string jID, string mstatus)
        {
            var jIDParameter = jID != null ?
                new ObjectParameter("JID", jID) :
                new ObjectParameter("JID", typeof(string));
    
            var mstatusParameter = mstatus != null ?
                new ObjectParameter("Mstatus", mstatus) :
                new ObjectParameter("Mstatus", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_try_Result>("sp_try", jIDParameter, mstatusParameter);
        }
